...
annopath = os.path.join('./data/Xray20190723/Anno_core_coreless_battery_sub_2000_500', '%s.xml')#测试集标注文件路径
test_imagesetfile = './data/Xray20190723/train_test_txt/battery_sub/core_coreless_test.txt'#测试集里面的图片名
...
def do_python_eval(output_dir='output', use_07=False):
    ...
    #    os.mkdir(output_dir)
    print('读取路径：',args.predicted_file)
...
def parse_rec(filename):
    ...
    try:
        ...
        # print('2222222',height,width,channels)
    except:
        print('error')
